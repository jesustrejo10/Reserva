<%@ Page Title="" Language="C#" MasterPageFile="~/view/RESFOM07/RESFOM7.Master" AutoEventWireup="true" CodeBehind="listar-reservas.aspx.cs" Inherits="frontoffice.view.RESFOM07.historico_reservas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <table class="table table-striped table-bordered table-hover" id="sample_1">
        ...
        <tbody>
            <tr>
                <td><a href="detalle-reserva.aspx">0000000000</a></td>
                <td>Hotel</td>
                <td>H5-030A</td>
