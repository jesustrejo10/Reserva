...
namespace TestUnitReserva.BO.gestion_ofertas
{
    [TestFixture]
    class TestOfertasYPaquetes
    {
        ...
        {
            CPaquete paq = new CPaquete();
            paq._nombrePaquete = "Paquete Especial de Navidad";
            paq._precioPaquete = 2570;
            paq._idOferta = 25;
            paq._idAuto = "08B1AOE";
        ...
        {
            Boolean resultado = prueba.activarPaquete(23);
        ...
        {
            Boolean resultado = prueba.desactivarPaquete(23);
            Assert.AreEqual(resultado, true);
        }
        ...
        {
            Boolean resultado = prueba.desactivarPaquete(25);
            Assert.AreEqual(resultado, true);
        }
        ...
        public void TestListarOfertaBd()
        {
            ...
            COferta oferta = prueba.MMostrarOfertaBD(25);
