    ...
    public class RestaurantDAO : DAO, IRestaurantDAO
    {
        ...
        public List<Entidad> Consultar(Entidad _lugar)
        {
            ...
            try
            {
                ...
                parametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.lug_id, SqlDbType.Int, lugar.Id.ToString(), true, false));
        ...
        public bool Crear(Entidad _restaurant)
        {
            ...
            try
            {
                ...
                listaParametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.rst_nombre, SqlDbType.VarChar, rest.nombre, false, false));
                listaParametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.rst_direccion, SqlDbType.VarChar, rest.direccion, false, false));
                listaParametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.rst_descripcion, SqlDbType.VarChar, rest.descripcion, false, false));
                listaParametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.rst_hora_apertura, SqlDbType.VarChar, rest.horarioApertura, false, false));
                listaParametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.rst_hora_cierre, SqlDbType.VarChar, rest.horarioCierre, false, false));
                listaParametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.rst_telefono, SqlDbType.VarChar, rest.Telefono, false, false));
                listaParametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.fk_lugar, SqlDbType.Int, rest.idLugar.ToString(), false, false));
                //el metodo Ejecutar Store procedure recibe la lista de parametros como el query, este ultimo es el nombre del procedimietno en la BD
        ...
        public bool Eliminar(Entidad _restaurant)
        {
            ...
            {   //Aqui se asignan los valores que recibe el procedimieto para realizar el delete, se repite tantas veces como atributos
                //se requiera en el where, para este caso solo el ID del restaurante @rst_id (parametro que recibe el store procedure)
                //se coloca true en Input 
                parametro.Add(FabricaDatosSql.asignarParametro(RecursoDAOM10.rst_id, SqlDbType.Int, rest.Id.ToString(), true, false));
                //el metodo Ejecutar Store procedure recibe la lista de parametros como el query, este ultimo es el nombre del procedimietno en la BD
