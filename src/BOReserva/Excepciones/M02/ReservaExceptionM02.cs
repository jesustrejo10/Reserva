...
namespace BOReserva.Excepciones.M02
{
    /// <summary>
    /// Clase que maneja las excepciones para el modulo 2
    /// </summary>
    public class ReservaExceptionM02 : Exception
    {
        ...
        public ReservaExceptionM02(string mensaje, ExceptionBD inner)
        {
            if (inner.InnerException.Message.Contains("Reserva_Vuelo"))
            {
                _Mensaje = "Reserva-404: Ese avion tiene asociado un vuelo, por ende no se puede eliminar del sistema";
                _Excepcion = inner;
            }
            else
            {
        ...
        public ReservaExceptionM02(string mensaje, NullReferenceException inner)
        {
        ...
        public ReservaExceptionM02(string mensaje, ArgumentNullException inner)
        {
        ...
        public ReservaExceptionM02(string mensaje, Exception inner)
        {
        ...
        /// <param name="mensaje">Mensaje de la excepcion</param>
        /// <param name="inner">Excepcion Exception</param>
        public ReservaExceptionM02(string mensaje, LogException inner)
        {
